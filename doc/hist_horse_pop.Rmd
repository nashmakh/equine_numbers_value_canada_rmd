...
knitr::kable(max_horses, 
             caption = "Table1. Max and min number of horse for each province between 1940 - 1972")
```

Below we zoom in and look at the province of `r params$province`:

```{r plot province, fig.width=5, fig.height=4, fig.cap="Figure 1. Horse populations for all provinces in Canada between 1940 - 1972", out.width="50%"}
